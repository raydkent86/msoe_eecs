...
ARCHITECTURE structure OF counter_gray_3bit_de10 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \DUT|QSIG[1]~0_combout\ : std_logic;
SIGNAL \DUT|QSIG[2]~1_combout\ : std_logic;
SIGNAL \DUT|SYNTHESIZED_WIRE_4~0_combout\ : std_logic;
SIGNAL \CK|cnt\ : std_logic_vector(25 DOWNTO 0);
SIGNAL \DUT|QSIG\ : std_logic_vector(2 DOWNTO 0);
...
\DUT|QSIG[1]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \DUT|QSIG[1]~0_combout\ = (\DUT|QSIG\(0) & (\SW[1]~input_o\ $ ((!\DUT|QSIG\(2))))) # (!\DUT|QSIG\(0) & (((\DUT|QSIG\(1)))))
...
\DUT|QSIG[2]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \DUT|QSIG[2]~1_combout\ = (\DUT|QSIG\(0) & (((\DUT|QSIG\(2))))) # (!\DUT|QSIG\(0) & (\SW[1]~input_o\ $ (((\DUT|QSIG\(1))))))
...
\DUT|SYNTHESIZED_WIRE_4~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \DUT|SYNTHESIZED_WIRE_4~0_combout\ = \SW[1]~input_o\ $ (\DUT|QSIG\(2) $ (!\DUT|QSIG\(1)))
...
PORT MAP (
	...
	datac => \DUT|QSIG\(2),
	datad => \DUT|QSIG\(1),
	combout => \DUT|SYNTHESIZED_WIRE_4~0_combout\);
...
PORT MAP (
	clk => \CK|clk_sig~clkctrl_outclk\,
	d => \DUT|SYNTHESIZED_WIRE_4~0_combout\,
	clrn => \SW[0]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|QSIG\(0));

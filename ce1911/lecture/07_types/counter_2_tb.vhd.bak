...
architecture behavioral of counter_2 is
	signal cnt_sig1: unsigned(7 downto 0); -- integral value
	signal cnt_sig2: unsigned(7 downto 0);
	signal cnt_sig3: signed(7 downto 0);	-- for shits and giggles
